    ...
    <>
      <header className="header">
        ...
        <nav className="menu" id="mn">
          <a href="#home" className="links" onClick={close}>
            Home
          </a>
          <a href="#svc" className="links" onClick={close}>
            Services
          </a>
          <a href="#abt" className="links" onClick={close}>
            About
          </a>
          <a href="#cnt" className="links" onClick={close}>
            Contact
          </a>
        </nav>

        <button className="login" type="submit" onClick={()=>location.href = "/login"}>
